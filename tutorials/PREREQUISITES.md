...
```bash
pip install "granite-switch[vllm]"    # vLLM 0.24.x (CUDA 13+, PyTorch 2.11+)
pip install "granite-switch[vllm20]"  # vLLM 0.25.x (CUDA 13+, PyTorch 2.11+)
```

This includes:
- `vllm>=0.24.0` for high-performance inference
